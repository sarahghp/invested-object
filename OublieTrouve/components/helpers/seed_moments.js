let moments = [
  ...
  {
    date_time: new Date(2014, 6, 28, 12),
    location: {
      longitude: '-73.997351',
      latitude: '40.692322',
    },
  ...
  {
    date_time: new Date(2015, 11, 27, 13),
    location: {
  ...
  {
    date_time: new Date(2016, 9, 12, 16),
    location: {
  ...
  {
    date_time: new Date(2016, 3, 2, 11),
    location: {
      longitude: '-73.92112375618241',
      latitude: '40.70915962617131',
    },
...
let populated_moments = _.map(moments, function(m, i){
  ...
  m.title = m.title || date.toString().split(' ').slice(0, 5).join(', ');
